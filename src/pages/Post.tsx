...
export default function Post() {
  ...
  return (
    <main className="relative min-h-screen text-white flex flex-col">
      ...
      <header className="px-3 pt-2.5 pb-2 flex items-center justify-between order-last md:order-first fixed bottom-0 left-0 right-0 md:static bg-black/90 backdrop-blur-sm md:bg-transparent md:backdrop-blur-none z-10">
        <Link
          to={`/${kind}/${category}`}
          aria-label={category}
      ...
      <article className="relative bg-black px-4 pb-16 pt-4 m-4 mx-auto w-full max-w-3xl">
